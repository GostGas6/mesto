...
const closeEdit = document.querySelector('.popup__close__button');
...
const imagePopup = popupImage.querySelector('.popup__image__image');
const imagePopupHeading = popupImage.querySelector('.popup__image__text');
